...
For a given datatype represented by two-evel-types\cite{sheard04}, if one of its 
interpretations depends on a second interpretation, we compose the algebra correponding 
to this interpretation with the algebra corresponding to the second one, and use the 
composed algebra with {\em fold} to evaluate the expression. 

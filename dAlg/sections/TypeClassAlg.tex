...
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\Varid{gstretch}\;[\mskip1.5mu \mathrm{2},\mathrm{2}\mskip1.5mu]\;(\Varid{gfan}\;\mathrm{2})\mathbin{`\Varid{gabove}`}{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}(\Varid{gidentity}\;\mathrm{1}\mathbin{`\Varid{gbeside}`}\Varid{gfan}\;\mathrm{2}\mathbin{`\Varid{gbeside}`}\Varid{gidentity}\;\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
